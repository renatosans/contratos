...
CREATE TABLE IF NOT EXISTS `addOnContratos`.`leitura` (
  ...
  `obs` VARCHAR(4000) NOT NULL DEFAULT 'observações',
...
CREATE TABLE IF NOT EXISTS `addOnContratos`.`equipamento` (
  ...
  `sla` INT NULL,
  `vendedor` INT NULL,
  `instaladoPor` INT NULL,
  PRIMARY KEY (`id`),
  UNIQUE INDEX `insID_UNIQUE` (`id` ASC),
  INDEX `fk_equipamento_modelo_idx` (`modelo` ASC),
...
CREATE TABLE IF NOT EXISTS `addOnContratos`.`acessorios` (
  ...
  PRIMARY KEY (`id`),
  UNIQUE INDEX `id_UNIQUE` (`id` ASC),
  INDEX `fk_acessorios_equipamento_idx` (`equipamento` ASC),
...
START TRANSACTION;
USE `addOnContratos`;
INSERT INTO `addOnContratos`.`login` (`id`, `idExterno`, `nome`, `usuario`, `senha`, `removido`) VALUES (1, NULL, 'Administrador', 'root', '67bscBlThU', 0);
...
INSERT INTO `addOnContratos`.`fabricante` (`id`, `nome`) VALUES (7, 'Ricoh');
...
-- -----------------------------------------------------
-- Data for table `addOnContratos`.`equipamento`
-- -----------------------------------------------------
START TRANSACTION;
USE `addOnContratos`;
INSERT INTO `addOnContratos`.`equipamento` (`id`, `manufacturerSN`, `internalSN`, `itemCode`, `itemName`, `customer`, `custmrName`, `contactPerson`, `addressType`, `street`, `streetNo`, `building`, `zip`, `block`, `city`, `state`, `country`, `instLocation`, `status`, `installationDate`, `installationDocNum`, `counterInitialVal`, `removalDate`, `removalDocNum`, `counterFinalVal`, `modelo`, `capacidade`, `sla`, `vendedor`, `instaladoPor`) VALUES (1, 'A5C0011032437', 'WX7005', '123456', 'Konica Minolta Bizhub C454e', '3', '', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'A', NULL, NULL, NULL, NULL, NULL, NULL, 5, NULL, NULL, NULL, NULL);
INSERT INTO `addOnContratos`.`equipamento` (`id`, `manufacturerSN`, `internalSN`, `itemCode`, `itemName`, `customer`, `custmrName`, `contactPerson`, `addressType`, `street`, `streetNo`, `building`, `zip`, `block`, `city`, `state`, `country`, `instLocation`, `status`, `installationDate`, `installationDocNum`, `counterInitialVal`, `removalDate`, `removalDocNum`, `counterFinalVal`, `modelo`, `capacidade`, `sla`, `vendedor`, `instaladoPor`) VALUES (2, 'A0V0011001804', 'EF4608', '123456', 'COPIADORA Bizhub PRO C6501', '3', '', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'A', NULL, NULL, NULL, NULL, NULL, NULL, 6, NULL, NULL, NULL, NULL);

COMMIT;


-- -----------------------------------------------------
-- Data for table `addOnContratos`.`acessorios`
-- -----------------------------------------------------
START TRANSACTION;
USE `addOnContratos`;
INSERT INTO `addOnContratos`.`acessorios` (`id`, `equipamento`, `codigoItem`, `descricaoItem`, `quantidade`) VALUES (1, 2, '123456', 'Bandeja de papel de saída para Bizhub PRO C6501', 4);
INSERT INTO `addOnContratos`.`acessorios` (`id`, `equipamento`, `codigoItem`, `descricaoItem`, `quantidade`) VALUES (2, 2, '123456', 'Painel de controle para Bizhub PRO C6501', 1);
INSERT INTO `addOnContratos`.`acessorios` (`id`, `equipamento`, `codigoItem`, `descricaoItem`, `quantidade`) VALUES (3, 2, '123456', 'Grampo Case 15AA43560 para Bizhub C6501', 2);
INSERT INTO `addOnContratos`.`acessorios` (`id`, `equipamento`, `codigoItem`, `descricaoItem`, `quantidade`) VALUES (4, 1, '123456', 'Gabinete para Bizhub C454e', 1);
