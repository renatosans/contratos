...
START TRANSACTION;
USE `addOnContratos`;
INSERT INTO `addOnContratos`.`acessorios` (`id`, `equipamento`, `codigoItem`, `descricaoItem`, `quantidade`) VALUES (1, 123, '456', 'Unidade de Fusão EP-6001', 2);
