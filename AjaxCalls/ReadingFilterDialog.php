...
// Dialogo com os filtros do relatório de leituras
...
$readingSources = $readingDAO->RetrieveReadingSources();
...
<form name="fDados" >
    ...
    <label class="left" style="width:99%; text-align: left;">Origem da Leitura<br/>
    <select name="readingSource" style="width: 98%;" >
        <option value=0 >-- Todas --</option>
        <?php
            foreach ($readingSources as $key=>$value) {
...
<script type="text/javascript" >
    ...
    function OkButtonClicked() {
        ...
        var readingSource = $("select[name=readingSource]").val();
        var parameters = '?businessPartnerCode=' + businessPartnerCode + '&model=' + model + '&equipmentCode=' + equipmentCode + '&startDate=' + startDate + '&endDate=' + endDate + '&readingSource=' + readingSource;
