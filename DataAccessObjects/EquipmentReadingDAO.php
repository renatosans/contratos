...
class EquipmentReadingDAO {
    ...
    function RetrieveRecordArray($filter = null){
        ...
        $query  .= "JOIN MYSQL.addoncontratos..contador CONTADOR ON LEITURA.contador_id = CONTADOR.id ";
        $query  .= "JOIN OHEM FUNCIONARIO ON LEITURA.assinaturaDatacopy = FUNCIONARIO.empId ";
        $query  .= "JOIN MYSQL.addoncontratos..formaLeitura FORMA ON LEITURA.formaLeitura_id = FORMA.id ";
        $query  .= "JOIN MYSQL.addoncontratos..origemLeitura ORIGEM ON LEITURA.origemLeitura_id = ORIGEM.id ";
        $query .= "              ) LEITURAS ";
